<template>
  <div class="contract">
    ...
    <div class="contract-tab">
      <div class="contract-tab-item" @click="router.push('/trade')">{{t('spotTrades')}}</div>
      <div class="contract-tab-item active">{{t('contract')}}</div>
      <div class="contract-tab-item" @click="router.push('/flash')">{{t('secondContract')}}</div>
      <div class="contract-tab-item" @click="router.push('/flashOption')">{{t('options')}}</div>
      <div class="contract-tab-item" @click="router.push('/floworder')">{{t('followTrades')}}</div>
    </div>
