...
export const contractHistoryList = (data) =>
  post(`/api/contract/position/list?status=${data.status}&pageNum=1&pageSize=100000`)
/**
 *
 * @param {*} data
 * @returns 极速平仓
...
export const getContractList = () => get(`/api/record/trading`)
export const getCurrencyList = () => get(`/api/record/currency`)
export const getOptionList = () => get(`/api/record/option`)
export const getBrokerList = () => get(`/api/record/broker`)
